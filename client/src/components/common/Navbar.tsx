...
import { Car, Globe, LogOut, Shield, User as UserIcon, KeyRound } from 'lucide-react';
            ...
            {user && (
              <div className="flex items-center gap-2 pl-2 border-l border-slate-800 rtl:border-l-0 rtl:border-r rtl:pr-2">
                <button
                  ...
                  className="flex items-center gap-2 hover:opacity-80 transition-opacity cursor-pointer text-left rtl:text-right"
