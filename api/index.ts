  ...
  return {
    settings: {
      ...
      fixedRoutes: [
        {
          id: 'route_1',
          pickupName: 'Tahrir Square (Downtown)',
          destinationName: 'Cairo Airport Terminal 3',
          price: 220,
          isActive: true,
        ...
        {
          id: 'route_2',
          pickupName: 'Citystars Mall (Nasr City)',
          destinationName: 'Cairo Airport Terminal 3',
          price: 120,
          isActive: true,
          isBidirectional: true,
        ...
        {
          id: 'route_4',
          pickupName: 'Zamalek (Gezira Island)',
          destinationName: 'Citystars Mall (Nasr City)',
          price: 130,
          isActive: true,
          isBidirectional: true,
          createdAt: new Date().toISOString(),
        ...
        {
          id: 'route_5',
          pickupName: 'New Cairo (5th Settlement)',
          destinationName: 'Cairo Airport Terminal 3',
          price: 140,
          isActive: true,
          isBidirectional: true,
